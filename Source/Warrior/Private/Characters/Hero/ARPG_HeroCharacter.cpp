...
void AARPG_HeroCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	ARPGInputComponent->BindAbilityInputAction(InputConfigDataAsset,this,&ThisClass::Input_AbilityInputPressed,&ThisClass::Input_AbilityInputReleased);
}
...
void AARPG_HeroCharacter::Input_AbilityInputPressed(FGameplayTag InInputTag)
{
	ARPG_AbilitySystemComponent->OnAbilityInputPressed(InInputTag);
}

void AARPG_HeroCharacter::Input_AbilityInputReleased(FGameplayTag InInputTag)
{
	ARPG_AbilitySystemComponent->OnAbilityInputReleased(InInputTag);
}
